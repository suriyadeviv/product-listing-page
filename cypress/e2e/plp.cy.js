describe('Product Listing App - Desktop view', () => {
  ...
  it('should lazy load images below the fold', async () => {
    ...
    it('should allow users to search products', async () => {
      await cy.wait(1000);
    ...
    it('should clear the search input when reset button is clicked', async () => {
      await cy.wait(1000);

      cy.get('#search-input').type('Cypress Testing');
